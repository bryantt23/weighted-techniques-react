...
function TechniquesRaw() {
    ...
    return (
        <div>
            ...
            <ul>
                {techniquesDisplayed.map((technique, index) => (
                    <TechniqueRaw key={technique._id} technique={technique} index={index} />
                ))}
            </ul>
            <button
                className="go-to-top"
